...
for i in range(1, 13, 1):
    numeric = text(pos=vector(clockR*0.75*np.cos(Angle),clockR*0.75*np.sin(Angle)-numH/2,0),text=str(i), color=color.orange, align="center", depth=clockT, height=numH)
    Angle = Angle+AngleInc
